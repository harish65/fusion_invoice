 ...
 */
 ...
 $translations = [
    ...
    'allow_line_item_discounts'                   => 'Autoriser les remises sur les articles',
    ...
    'complete-with-note'                          => 'Complet avec notice',
    ...
    'third_party_bill_payer'                      => 'Payeur de facture tiers',
    ...
    'tt_default_currency'                         => 'La devise attribuée à ce compte client, qui sera utilisée pour leurs factures, devis et transactions de paiement. Cette valeur est la valeur par défaut du paramètre système pour la devise de base.',
    ...
    'tt_db_accumulate_totals'                     => 'Si vous activez cette valeur, votre graphique inclura les totaux des jours précédents pour chaque jour. Par exemple, les ventes du jour 1 étaient de 100 $, celles du jour 2 de 50 $ et celles du jour 3 de 125 $. Le graphique afficherait une ligne ascendante avec cette option définie sur Oui. Définir sur Non, afficherait une baisse de la ligne de vente le jour 2 et augmenterait au jour 3.',
    ...
    'tt_ss_email_allow_self_cert'                 => 'L\'activation de cette option désactive l\'exigence PHP verify_peer. Pour plus d\'informations, recherchez sur Internet : Certificat auto-signé de messagerie PHP openssl.cafile',
    ...
    'tt_ss_pdf_driver'                            => 'Le pilote à utiliser lors de la création de documents PDF. La sélection du pilote \'wkhtmltopdf\' nécessite une installation de ce programme sur le serveur local et la définition du chemin binaire approprié pour celui-ci.',
    ...
    'tt_ss_olp_about'                             => 'FusionInvoice prend en charge plusieurs fournisseurs de paiement en ligne. Activez les fournisseurs avec lesquels vous avez établi des comptes. Les fournisseurs activés ici seront affichés en tant qu\'options de paiement, lorsque vos clients consulteront leurs factures à l\'aide du lien de facturation public (inclus dans l\'e-mail de facturation par défaut).',
    ...
    'secure_link_and_expire_link_days'            => 'Sécuriser et faire expirer les liens de facturation publics',
    ...
    'social_media_url'                            => 'URL des médias sociaux',
