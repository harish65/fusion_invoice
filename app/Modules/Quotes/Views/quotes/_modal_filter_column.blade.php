<script type="text/javascript">
    $(function () {
        ...
        $('.btn-quotes-clear-column-filter-close').click(function (){
    ...
    <div class="modal-dialog text-break">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close btn-quotes-clear-column-filter-close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <form id="columns-filter">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-12">
                        ...
                        <button type="button" id="btn-submit-column-setting" data-url="{{ route('quote.store.filterColumnSetting') }}" class="btn btn-sm btn-primary float-right ml-2 ">{{ trans('fi.submit') }}</button>
                        <button type="button" class="btn btn-sm btn-default float-right btn-quotes-clear-column-filter-close" data-dismiss="modal" id="btn-clear-column-filter">{{ trans('fi.close') }}</button>
