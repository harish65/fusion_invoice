            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-sm btn-primary" id="btn-run-migration">{{ trans('fi.continue') }}</a>

                        <a class="btn btn-sm btn-default" id="btn-running-migration" style="display: none;" disabled="disabled">{{ trans('fi.installing_please_wait') }}</a>

                        <a href="{{ route('setup.account') }}" class="btn btn-sm btn-success" id="btn-migration-complete" style="display: none;">{{ trans('fi.continue') }}</a>
