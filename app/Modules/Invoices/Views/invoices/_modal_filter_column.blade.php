<script type="text/javascript">
    $(function () {
        ...
        $('#btn-submit-column-setting').click(function (evt) {
            ...
            evt.stopPropagation();
            evt.preventDefault();
            var formAllData = $('#columns-filter').serializeFormJSON();
            ...
            $.each(obj, function (objIndex, objValue) {
                $.each(formAllData, function (index, value) {
                    ...
                    if (result == true) {
                        if ('columns[' + objIndex + ']' == filter_column) {
                            formAllData[index] = objValue;
                        }
                    }
                });
            });

            $.post($_this.data('url'), formAllData)
        ...
        $('.btn-invoice-clear-column-close').click(function (){
    ...
    <div class="modal-dialog text-break">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close btn-invoice-clear-column-close" data-dismiss="modal" aria-hidden="true" >&times;</button>
            </div>
            <form id="columns-filter">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-12">
                        ...
                        <button type="button" id="btn-submit-column-setting" data-url="{{ route('invoice.store.filterColumnSetting') }}" class="btn btn-sm btn-primary float-right ml-2">{{ trans('fi.submit') }}</button>
                        <button type="button" class="btn btn-sm btn-default float-right btn-invoice-clear-column-close" data-dismiss="modal" id="btn-clear-column-filter">{{ trans('fi.close') }}</button>
